...
@Component({
  selector: 'app-resumen-socios-excel',
  templateUrl: './resumen-socios-excel.component.html',
  styleUrls: ['./resumen-socios-excel.component.css']
})
export class ResumenSociosExcelComponent implements OnInit {
  ...
  establecimientosProduce = [
      ...
      { codigo: '39', nombre: 'CISKA', produce: 3 },
      { codigo: '40', nombre: 'LA NINA', produce: 2 },
      { codigo: '41', nombre: 'ALLENDE', produce: 3 },
  ...
  ngOnInit(): void {
      ...
      this.cols = [
          { field: "produce", header: "SOCIO" },
          { field: "destino", header: "DESTINO" },
          { field: "kg_neto_orig", header: "TOTAL KGS ORIGEN" },
          { field: "kg_neto_dest", header: "TOTAL KGS DESTINO" },
      ];
  ...
  comenzarTratamiento() {
      ...
      this.sociosSeleccionados.map((socio:any) => {
          ...
          this.dataParaMostrarTabla = [ ...this.dataParaMostrarTabla, ...dataDestino ]
  ...
  */
  ...
  transformarDatoMostrar(dato: any, tipo: any) {
      ...
      if (tipo == 'produce') {
        return this.socios.find((e:any) => {return e.id == dato}).alias
      }
      if (tipo == 'destino') {
          return this.DIC_destinos[dato].nombre ? this.DIC_destinos[dato].nombre : '-'
      }

      if (tipo == 'kg_neto_orig' || tipo == 'kg_neto_dest') {
