...
@Component({
  selector: 'app-movimientos-produccion-resumen',
  templateUrl: './movimientos-produccion-resumen.component.html',
  styleUrls: ['./movimientos-produccion-resumen.component.css']
})
export class MovimientosProduccionResumenComponent implements OnInit {
